...
const envSchema = z.object({
  EXPO_PUBLIC_REVENUE_CAT_IOS_API_KEY: z.string().optional().default(''),
  EXPO_PUBLIC_REVENUE_CAT_ANDROID_API_KEY: z.string().optional().default(''),
  EXPO_PUBLIC_ENTITLEMENT_IDENTIFIER: z.string().optional().default(''),
  ...
  EXPO_PUBLIC_CLARITY_ID: z.string().optional().default(''),
