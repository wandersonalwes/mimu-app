...
export function SpainIcon(props: SvgProps) {
  return (
    <Svg width={16} height={12} viewBox="0 0 16 12" fill="none" {...props}>
      <G clipPath="url(#clip0_270_54993)">
        <Path fill="#fff" d="M0 0H16V12H0z" />
        <Path fillRule="evenodd" clipRule="evenodd" d="M0 0v12h16V0H0z" fill="#FFB400" />
        <Mask
          id="a"
          style={{
            maskType: 'luminance',
        ...
        <G mask="url(#a)">
          <Path
            ...
            fill="#C51918"
          />
          <Path fill="#F1F9FF" d="M2.50403 5.13599H3.0640300000000003V8.047989999999999H2.50403z" />
          <Path
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          <Path fill="#F1F9FF" d="M7.992 5.13599H8.552V8.047989999999999H7.992z" />
          <Path
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          <Path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M7.388 3.603v-.082a1.53 1.53 0 00-.905-.31 1.806 1.806 0 00-.918-.156v-.001c-.465-.046-.934.157-.934.157-.473 0-.905.31-.905.31v.082l.565.567s.159.546 1.272.418v.001s.737-.02.79-.037l.063-.02c.144-.042.31-.09.407-.362l.565-.567zm-1.825-.519z"
            fill="#AD1619"
          />
          <Path
            fillRule="evenodd"
          ...
          <Path
            ...
            fill="#C88A02"
          />
          <Path fill="#C88A02" d="M5.47198 2.672H5.6959800000000005V3.4000000000000004H5.47198z" />
          <Path
            d="M3.854 3.648l-.308-.011c.145-.839.86-1.25 2.002-1.25 1.144 0 1.856.413 1.99 1.255l-.415.043c-.066-.41-.752-.78-1.569-.78-.818 0-1.629.33-1.7.743z"
            fill="#C88A02"
          />
          <Path
            opacity={0.3}
          ...
          <G mask="url(#b)">
            <Path fill="#FFC034" d="M3.73602 6.64798H5.58402V8.83198H3.73602z" />
            <Path fill="#AD1619" d="M3.73602 4.57599H5.58402V6.70399H3.73602z" />
            <Path fill="#AD1619" d="M5.52802 6.59198H7.37602V8.71998H5.52802z" />
            <Path fill="#F1F9FF" d="M5.52802 4.63199H7.48802V6.70399H5.52802z" />
            <Path
              fillRule="evenodd"
              clipRule="evenodd"
