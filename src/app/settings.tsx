...
export default function SettingsScreen() {
  ...
  return (
    <SafeAreaView edges={['bottom']} style={{ flex: 1 }}>
      {/* Banner PRO */}
      <TouchableOpacity
        className="mx-5 mt-4 mb-6 flex-row items-center gap-4 px-6 py-4 bg-primary rounded-xl"
        onPress={goToSubscription}
      >
        <Text className="text-sm font-manrope-bold leading-5 text-card flex-1">
          Aprenda mais rápido com o Mimu PRO
        </Text>
        <View className="flex-row justify-center items-center px-3 py-2 bg-primary-foreground rounded-[20px]">
          <Text className="text-xs font-manrope-semibold leading-4 text-primary">
      ...
      {/* Notificações */}
      <View className="mx-5 mb-4 flex-row justify-between items-center gap-4 px-5 py-3.5 bg-card rounded-xl">
        <Text className="text-sm font-manrope-regular leading-5 text-foreground">Notificações</Text>
      ...
      >
        <View className="flex-1 gap-2">
          <Text className="text-sm font-manrope-regular leading-5 text-foreground">Idioma</Text>
      ...
      {/* Avaliar app */}
      <TouchableOpacity className="mx-5 flex-row justify-between items-center gap-4 px-5 py-3.5 bg-card rounded-xl">
        <Text className="text-sm font-manrope-regular leading-5 text-foreground">Avaliar app</Text>
        <CaretRightIcon size={24} color="#FFFFFF" weight="regular" />
      </TouchableOpacity>
